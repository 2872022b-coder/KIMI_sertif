...
export function initSeedData() {
  ...
  const createProductImages = (count) =>
  ...
  const products = [
    {
      ...
      productImages: createProductImages(10),
      createdAt: now
    },
    {
      id: 'P2',
      ...
      productImages: createProductImages(5),
      createdAt: now
    },
    {
      id: 'P3',
      ...
      gallery: [placeholderImg],
      productImages: createProductImages(8),
      createdAt: now
    },
    {
      id: 'P4',
      ...
      productImages: createProductImages(12),
      createdAt: now
    },
    {
      id: 'P5',
      ...
      gallery: [placeholderImg],
      productImages: createProductImages(7),
      createdAt: now
    },
  ];
